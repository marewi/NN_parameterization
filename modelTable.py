...
class Model_table:
    def __init__(self):
        ...
        amount_momentum = int((momentum_max - momentum_min + momentum_stepsize) * (1 / momentum_stepsize))
        self.q_table = {}
        for i in range(amount_num_epochs):
            ...
            for ii in range(amount_batch_size):
                ...
                for iii in range(amount_learning_rate):
                    ...
                    for iiii in range(amount_momentum):
                        self.q_table[(i/(1/num_epochs_stepsize), 
                            ii/(1/batch_size_stepsize), 
                            iii/(1/learning_rate_stepsize),
                            iiii/(1/momentum_stepsize))] = [0 for i in range(8)]
